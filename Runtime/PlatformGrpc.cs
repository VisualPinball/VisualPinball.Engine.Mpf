...
namespace Mpf.Vpe {
  public static partial class MpfHardwareService
  {
    ...
    static readonly grpc::Marshaller<global::Mpf.Vpe.MachineState> __Marshaller_mpf_vpe_MachineState = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.MachineState.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Mpf.Vpe.Commands> __Marshaller_mpf_vpe_Commands = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.Commands.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Mpf.Vpe.EmptyRequest> __Marshaller_mpf_vpe_EmptyRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.EmptyRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Mpf.Vpe.MachineDescription> __Marshaller_mpf_vpe_MachineDescription = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.MachineDescription.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Mpf.Vpe.SwitchChanges> __Marshaller_mpf_vpe_SwitchChanges = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.SwitchChanges.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Mpf.Vpe.EmptyResponse> __Marshaller_mpf_vpe_EmptyResponse = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.EmptyResponse.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Mpf.Vpe.QuitRequest> __Marshaller_mpf_vpe_QuitRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Mpf.Vpe.QuitRequest.Parser.ParseFrom);
